...
```{r}
by_age <- readRDS(here::here("reports/survival to 1985/resources", "small.survival_by_age.rds"))
by_employment <- readRDS(here::here("reports/survival to 1985/resources", "small.survival_by_employment-status.rds"))

bytimevarying.tab <- rbindlist(list(
	by_age,
	by_employment), idcol = "Covariate", use.names = F)
...
\includegraphics[scale=0.85]{`r here::here("reports/survival to 1985/resources", "small.roc.pdf")`}
...
\includegraphics[scale=0.85]{`r here::here("reports/survival to 1985/resources", "roc.pdf")`}
